...
listOfWordsS=["","apple","ball","cat","dog","elephant","girl","house","icecream","language","water","sweet","dangerous","train",
"amazing","pineapple","saturday","difficult","umbrella","sunflower","wonderful","butterfly","rainbow"]
listOfWordsM=["","welcome","purple","level","bubble","kite","snake","queen","language","elephant","beautiful","water","sweet","dangerous","train",
"amazing","pineapple","saturday","difficult","umbrella","sunflower","wonderful","butterfly","rainbow"]
listOfWordsH=["","welcome","difficult","stawberry","gorgeous","obedience","struggle","requirement"]             

#creating a list of Random words related to actual word :
listOfGumble_WS=["","pplea","lalb","tac","odg","telphnae","lirg","sohue","micreace","guagelan","tware","teesw","gerdanuso","raint",
"angimza","appnepile","saydurta","culitffid","mallebur","werfunlos","flowunder","tterlybuf","bownari"]
listOfGumble_WM=["","comewel","ppreul","ellev","itek","fulbeutia","eblbub","ansek","nqeeu","langeuag","telphnae","tware","teesw","gerdanuso","raint",
"angimza","appnepile","saydurta","culitffid","mallebur","werfunlos","flowunder","tterlybuf","bownari"]
listOfGumble_WH=["","comewel","culitffid","stabwerry","orosguge","enceobedi","ggrustle","requirement"]
...
"A day","opposite to EASY","use in rainy season","A flower","______FUL","next generation of catterpiller","set of seven colour"]
Hint_wordsH=["","we say-after thanks","opposite to EASY","A small red fruit","A very big","obe__ence","hard work to success in life","re-----m-nt"]
...
if (age>=5 and age<10):
    ...
    print("\n\t______::: Hint-CLICK 1 :::_______\t\tTotal level:",len(listOfGumble_WM)-1)
    m=Medium6_10
    #taking level from user:
    k=int(input("\nLEVEL NO:"))
    #For loop to perform number of task equal to the no. of LEVEL
    ...
    print("\n\t______::: Hint-CLICK 1 :::_______\t\tTotal level:",len(listOfGumble_WH)-1)
    h=High11_15
    #taking level from user:
    k=int(input("\nLEVEL NO:"))
    #For loop to perform number of task equal to the no. of LEVEL
